    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-mainbg p-0 opacity-50 hover:bg-subbg dark:hover:bg-subbg",
        ),
        ...
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-subbg dark:hover:bg-subbg",
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-mainbg text-slate-50 hover:bg-subbg hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:text-slate-900 dark:hover:bg-subbg dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today: "bg-subbg text-slate-900 dark:bg-subbg dark:text-slate-50",
        day_outside:
